...
function DetailesAccessories({ dataDatail, setAccion, dataUser }) {
  ...
  let { titulo, plataforma, descripcion, precio, garantia, publicador, lanzamiento, condicion, idProducto } = dataDatail["producto"]
